...
from src.MRC.train_mrc_PRE import QaRunner
import os
import json
...
class Evaluator:
    def __init__(self, config_name, saved_suffix, gpu_id, config_file="PRE_experiments.conf"):
        self.saved_suffix = saved_suffix
        self.runner = QaRunner(config_name, gpu_id, saved_suffix=saved_suffix, config_file=config_file)
