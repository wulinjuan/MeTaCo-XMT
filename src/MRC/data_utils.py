...
def squad_convert_example_to_features(example, max_seq_length, doc_stride, max_query_length, is_training, padding_strategy, tokenizer, lang2id=None):
    features = []
    ...
    while len(spans) * doc_stride < len(all_doc_tokens) and span_doc_tokens !=[]:
...
class SquadProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir, task, languages=['en']):
        ...
        for lang in languages:
            if task == "tydiqa":
                filename = os.path.join(data_dir,
                                        "data/tydiqa/tydiqa-goldp-v1.1-train") + "/tydiqa." + lang + ".train.json"
                example_file = os.path.join(data_dir,
                                        "data/cached/tydiqa/tydiqa-goldp-v1.1-train") + "/tydiqa." + lang + ".train.pkl"
            else:
                filename = os.path.join(data_dir, "data/SQUAD") + "/squad/train-v1.1.json"
                example_file = os.path.join(data_dir, "data/cached/SQUAD") + "/squad/train-v1.1.pkl"
        ...
        return train_examples, example_file
    ...
    def get_dev_examples(self, data_dir, task, languages=['en']):
        ...
        for lang in languages:
            if task == "tydiqa":
                filename = os.path.join(data_dir,
                                        "data/tydiqa/tydiqa-goldp-v1.1-train") + "/tydiqa." + lang + ".dev.txt.json"
                example_file = os.path.join(data_dir,
                                        "data/cached/tydiqa/tydiqa-goldp-v1.1-train") + "/tydiqa." + lang + ".dev.txt.pkl"
            else:
                filename = os.path.join(data_dir, "data/MLQA_V1") + "/dev.txt/dev.txt-context-" + lang + "-question-"+lang+".json"
                example_file = os.path.join(data_dir, "data/cached/MLQA_V1") + "/dev.txt/dev.txt-context-" + lang + "-question-"+lang+".pkl"

            with open(filename, "r", encoding="utf-8"
            ) as reader:
                input_data = json.load(reader)["data"]

            dev_examples.extend(self._create_examples(input_data, "train", lang))

        return dev_examples, example_file
    ...
    def get_squad_dev_examples(self, data_dir, task, languages=['en']):
        ...
        for lang in languages:
            if task == "tydiqa":
                ...
                filename = os.path.join(data_dir, "data/SQUAD") + "/squad/dev.txt-v1.1.json"
                example_file = os.path.join(data_dir, "data/cached/SQUAD") + "/squad/dev.txt-v1.1.pkl"
    ...
    def get_test_examples(self, data_dir, task, language ='en', data_from='test'):
        """
        ...
        if task == "tydiqa":
            filename = os.path.join(data_dir, "data/tydiqa/tydiqa-goldp-v1.1-test") + "/tydiqa." + language + ".test.json"
            if data_from == 'train':
                filename = filename.replace('-test', '-train').replace('.test', '.dev.txt')
            example_file = os.path.join(data_dir, "data/cached/tydiqa/tydiqa-goldp-v1.1-test") + "/tydiqa." + language + ".test.pkl"
        else:
            filename = os.path.join(data_dir, "data/MLQA_V1") + "/test/test-context-" + language + "-question-" + language \
                       + ".json"
            example_file = os.path.join(data_dir, "data/cached/MLQA_V1") + "/test/test-context-" + language + "-question-" + language \
                       + ".pkl"
        ...
        test_examples = self._create_examples(input_data, "dev.txt", language)
        return test_examples, example_file
...
class SquadV1Processor(SquadProcessor):
    ...
    dev_file = "dev.txt-v1.1.json"


class SquadV2Processor(SquadProcessor):
    train_file = "train-v2.0.json"
    dev_file = "dev.txt-v2.0.json"
