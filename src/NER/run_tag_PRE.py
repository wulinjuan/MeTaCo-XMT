...
from utils_tag_PRE import convert_examples_to_features
from utils_tag_PRE import get_labels
from utils_tag_PRE import read_examples_from_file
...
def load_and_cache_examples(args, tokenizer, labels, pad_token_label_id, mode, lang, lang2id=None, few_shot=-1):
    ...
    if os.path.exists(cached_features_file) and not args.overwrite_cache:
        ...
        features = []
        for lg in langs:
            data_file = os.path.join(args.data_dir, lg, "{}".format(mode if lg=='en' or mode=='test' else 'dev'))
...
def main():
    ...
    parser.add_argument("--output_dir", default='../../output/NER/output_mbert/', type=str,
    ...
    elif os.path.exists(os.path.join(args.output_dir, 'checkpoint-final')):
