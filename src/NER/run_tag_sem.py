...
def load_and_cache_examples_meta(args, tokenizer, labels, pad_token_label_id, mode, lang,
    ...
    # Load data features from cache or dataset file
    cached_features_file = os.path.join(args.data_dir, "cached_{}_{}_{}_{}".format(mode, "en_features",
                                                                                   list(filter(None,
                                                                                               args.model_name_or_path.split(
                                                                                                   "/"))).pop(),
                                                                                   str(args.max_seq_length)))
...
def main():
    ...
    parser.add_argument("--output_dir", default='../../output/NER/output_mbert_sem/', type=str,
    ...
    parser.add_argument("--meta_steps", default=4, type=int)
    ...
    if args.do_train:
        train_dataset = load_and_cache_examples_meta(args, tokenizer, labels, pad_token_label_id, mode="train",
                                                     ...
                                                     sbert=True, ner_model=None, cl_model=None)
    ...
    # Prediction
    all_f1 = ""
    f = open('result_sem.txt', 'a+', encoding='utf-8')
