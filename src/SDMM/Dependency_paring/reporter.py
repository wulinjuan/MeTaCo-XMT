...
class Reporter:
  ...
  """
    ...
    Args:
      ...
      split_name the string naming the data split: {train,dev.txt,test}
    """
...
class WordPairReporter(Reporter):
    ...
    def report_spearmanr(self, prediction_batches, dataset):
    ...
    def report_uuas_and_tikz(self, prediction_batches, dataset):
...
class WordReporter(Reporter):
    ...
    def report_root_acc(self, prediction_batches, dataset):
