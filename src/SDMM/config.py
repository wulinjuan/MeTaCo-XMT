...
def get_base_parser():
    ...
    basic_group.add_argument('--save_file_path', type=str, default="../../output/sdmm/mbert_norm",  ####### change the file name
    ...
    plm_group.add_argument('--ml_token', type=str, default="bert-base-multilingual-cased",
                           help='pretrained language model token file: bert-base-multilingual-cased, xlm-roberta-base, xlm-roberta-large')
    ...
    config_group.add_argument('-use_prob', '--use_prob',
                              dest='use_prob',
                              type=bool,
                              default=True)
    config_group.add_argument('-distance_type', '--distance_type',
                              dest='distance_type',
                              type=str,
                              default='wdm',
                              help="choose from 'wdm' and 'cos'")
    ...
    setup_group.add_argument('--n_epoch', type=int, default=20,
